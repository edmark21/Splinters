...
###################[Armored up]####################
      ...
      return setteamm
    elif l['ruleset'] == "Armored Up|Healed Out":
      if "Green" in aa:
        fn = open("team/earth/healed_out.json")
        setteamm = json.load(fn)
      ...
      return setteamm
    elif l['ruleset'] == "Armored Up|Heavy Hitters":
      if "Green" in aa:
        fn = open("team/earth/standard.json")
        setteamm = json.load(fn)
